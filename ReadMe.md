...
## 🛠 Installation & Setup
This project is optimized for **uv**, the high-performance Python package and environment manager.
...
* **Cleaning Builds:** If you encounter issues during packaging, delete the `build/` and `dist/` folders before re-running the `py2app` command to ensure a "clean" compile.
